...
### [我的博客在这里 &rarr;](https://wuzhenyu533.github.io/)
...
我的博客仓库——`wuzhenyu533.github.io`，是经常修改的，而且还会有人乱提交代码，因此给大家做了一个稳定版的模板。大家可以直接fork模板——`huxblog-boilerplate`,要改的地方我都说明了。或者可以直接下载zip到本地自己去修改。
...
```
# Site settings
title: Wu Blog              # 你的博客网站标题
SEOTitle: Wu Blog 			# 在后面会详细谈到
description: "Cool Blog"    # 随便说点，描述一下

# SNS settings      
github_username: wuzhenyu     # 你的github账号
weibo_username: wuzhenyu      # 你的微博账号，底部链接会自动更新的。
...
---
layout:     keynote
iframe:     "http://huawuzhenyu533.github.iongxuan.me/js-module-7day/"
---
```
...
ga_domain: wuzhenyu533.github.io			# 默认的是 auto, 这里我是自定义了的域名，你如果没有自己的域名，需要改成auto。
```
...
标题底图是可以自己选的，看看几篇示例post你就知道如何设置了。在
  [issue #6 ](https://wuzhenyu533.github.io) 中我被问到：怎么样才能让标题底图好看呢？
...
我的博客标题是 **“Wu Blog ”** 但是我想要在搜索的时候显示 **“黄玄的博客 | Wu Blog ”** ，这个就需要SEO Title来定义了。
